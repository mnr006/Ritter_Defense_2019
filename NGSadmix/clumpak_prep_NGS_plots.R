...
par(mfrow=c(3,1), mai=c(0.25,0.1,.2,0.1))
...
abline(v = c(38, 75, 106, 155, 191), lty = 5, lwd = 2, col = "black")
#reogranzing plot
reorganizing_admix_K4 <- admixture_K4_run19[, c(192:226, 156:191, 107:155, 76:106, 1:38,39:75)]
populations_rearranged <- c(rep("Kalispell GRBD", 35),rep("Kalispell ST5R", 36),rep("Wurtz", 49),rep("Nyack HA15", 31),rep("Nyack HA19", 38),rep("Nyack HA9", 37))
barplot(reorganizing_admix_K4, col = c("lightskyblue", "forestgreen", "wheat", "lightsalmon4"), space = 0, border = NA, family = "serif", font = 2, font.lab = 2, font.axis = 2, axes= FALSE)
text(c(18, 53, 95, 136, 172, 208), -0.05, unique(populations_rearranged), 
     xpd = T, cex=3, family = "serif")
abline(v = c(35, 71, 120, 151, 189), lty = 5, lwd = 2.5, col = "black")
